...
exports.generateCaptionFromFields = generateCaptionFromFields;
function generateCaptionFromFields(what, where, when) {
    ...
    const isToday = inputDate.getFullYear() === today0.getFullYear() &&
